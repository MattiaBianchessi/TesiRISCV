...
\todo{Sezione/ due parole sulle pseudo istruzioni}
...
Per in alcuni sistemi non è presente nessun compilatore, per questi è possibile utilizzare la tecnica della cross-compilation (\todo{Reference section cross-compiler}).  Per una cross-compilazione di base è necessario avere una toolchain. una toolchain è l'insieme dei programmi usati nello sviluppo di un prodotto, tipicamente un altro programma o sistema di programmi. Tali strumenti sono utilizzati in catena in modo tale che producano del codice per un determinato dispositivo.
\todo{Componenti della toolchain ?}
...
I programmi utilizzati sono scritti in C e sono contenuti su gitHub sulla \todo{repo}
% \hrref{https://github.com/MattiaBianchessi/Testing_RISC-V}{repo}.
...
\todo{Valutazione generatore casuale}
...
\section{Operazioni}
	...
	Per riferimento il programma è stato utilizzato anche su un MacBook Air \todo{Ulteriori Info}.
...
\todo{Inserisci sorgenti Addizione generale}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
        ...
        \lstinputlisting[language = risc-v]{PorzioniCodice/ConfrontoCompilatori/Assembler/RISC-V/sumGen.txt}
	\label{Code:Add2RISC}
\caption{RISC-V}
     \end{subfigure}
     \hfill
...
\begin{figure}
	\begin{subfigure}[b]{0.4\textwidth}
          ...
          \lstinputlisting[language=C,  style = Cstyle,  caption = {Moltiplicazione per potenza di 2}, label = {Code:Mul31Comp}]{PorzioniCodice/ConfrontoCompilatori/C/mult31.c}	
		
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.4\textwidth}
         
          \lstinputlisting[language=C,  style = Cstyle,  caption = {Moltiplicazione per potenza di 2}, label = {Code:Mul30Comp}]{PorzioniCodice/ConfrontoCompilatori/C/mult30.c}	
...
\todo{Controllo eff pseudo istruzioni}
...
\todo{Inserisci valutazione generatore numeri casuali}
