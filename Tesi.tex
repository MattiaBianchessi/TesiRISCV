...
% 
\chapter{ISA RISC-V}
Prima di discutere dei risultati ottenuti presentiamo ISA.\todo{atrent: italiano}
%BASE ED ESTENSIONE
\section{Base}
...
\todo{alexj: Ho trovato i primi 2 capitoli molto più leggibili. Hai fatto bene a smaltire}
...
\todo{atrent: bibliografia! ad es. gcc e LLVM}
...
\todo{atrent: bibliografia! sull'opensource e sw libero}
...
\textit{Domanda: Ma tu hai usato CLANG?} \todo{atrent: non ho capito questa frase, forse era un todo?}
...
I programmi utilizzati sono scritti in C e sono contenuti su github in una \href{https://github.com/MattiaBianchessi/Testing_RISC-V}{repository}.\todo{atrent: mio dubbio, repo è maschile o femminile? per me maschile, cfr. \url{https://accademiadellacrusca.it/it/consulenza/quale-possibile-traducente-per-repository/2859}}
...
In entrambi i casi vengono utilizzate tecniche di backtracking\todo{atrent: vale in generale, i termini inglesi non assorbiti dall'italiano andrebbero in corsivo}.  Lo scopo è quello di valutare il tempo di esecuzione di programmi che fanno uso del backtracking su processore RISC.
