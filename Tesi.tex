...
Un altra area di applicazione è il \textit{machine learning} \cite{mlRISCV} grazie alla loro configurabilità ottengono la possibilità di soddisfare requisiti specifici \cite{louis2019towards}.
