...
\begin{figure}[h!]
     ...
     \begin{subfigure}{0.3\textwidth}
        ...
        \lstinputlisting[language = Risc-v, caption = {RISC-V}]{PorzioniCodice/ConfrontoCompilatori/Assembler/RISC-V/get_num.txt}
\label{Code:AddRISCV}
     ...
     \begin{subfigure}{0.3\textwidth}
          ...
          \lstinputlisting[language = Risc-v, caption = {Arm}]{PorzioniCodice/ConfrontoCompilatori/Assembler/ARM/get_num.txt}
...
\label{Code:AddARM}
     ...
     \begin{subfigure}{0.3\textwidth}
          ...
          \lstinputlisting[language = Risc-v, caption = {x86}]{PorzioniCodice/ConfrontoCompilatori/Assembler/x86/get_num.txt}
